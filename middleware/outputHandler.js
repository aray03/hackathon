    ...
    try {
        ...
        if (confidence < confidenceThreshold) {
            ...
            if (label === "Cardboard") {
                return {
                    type: "Cardboard",
                    message: `This is cardboard! Cardboard can be recycled by being broken down, flattened, and placed in the recycling bin. In Utah cardboard can be reycled at drop-off recycling or curbside pickup. Make sure to only recycle cardboard that is clean and dry.`,
                    color: "#8B4513",
                    confidence: confidence
                };
            }
                ...
                return {
                    ...
                    message: `This is miscellaneous trash! This can be disposed in a landfil or garbage bin!`,
                    color: "#d32f2f",
                    confidence: confidence
                };
            }
                ...
                return {
                    type: "Paper",
                    message: `This is paper! To dispose of paper responsibly, focus on high-quality recycling by ensuring that all items are clean, dry, and free of food contaminants like grease or oil. Paper can go directly into your curbside recycling bin if it is clean and dry. If it is contaminated, it should be placed in the regular trash. Remeber to shred sensitive documents before disposal.`,
                    color: "#F57C00",
                    confidence: confidence
                };
            }
